...
Boutonmail1 = Radiobutton(cadre5, text="Saintes", value='4', variable= "v")
Boutonmail2 = Radiobutton(cadre5, text="Royan", value='5', variable= "v")
Boutonmail3 = Radiobutton(cadre5, text="Saint Jean d'Angely", value='6', variable= "v")
Boutonmail1.pack(padx=5, pady=5, side=LEFT)
Boutonmail2.pack(padx=5, pady=5, side=LEFT)
Boutonmail3.pack(padx=5, pady=5, side=LEFT)
v = StringVar(fenetre, "1")
...
b = Button(fenetre, text="Valider", command=formulaireEnvoyé)
